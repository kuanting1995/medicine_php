...
<div class="row justify-content-center mb-5">
        <div class="col-4">
            <h2 class="text-center">修改會員密碼</h2>
        </div>
 </div> 
 ...
 <div class="container">
     <div class="row justify-content-center">
      <div class="col-6">
        <form name="form1" style="border:1px solid gray;background-color:#F6E7B0" class="px-5 py-4  rounded "  onsubmit="checkForm(event)">
            ...
            <div class="mb-3">
                ...
                <div class="   position-relative">
                    ...
                    <div id="seepass" >
                        ...
                        <i id="seepass2" style="display: inline;color:gray" class="fa-solid fa-eye-slash"></i></div>
                    <div class="form-text"></div>
...
let p2 = document.form1.password2;
   ...
   if(isPass){
       ...
       fetch('member_password_edit_api.php',{
           ...
           if(obj.success){
           showAlert('修改成功!','succ');
           setTimeout("location.href='member_detail.php?member_id=<?=$member_id?>'",1300);
           }
           else{
