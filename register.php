                ...
                <div class="card-body">
                    ...
                    <form name="form1" onsubmit="checkForm(event)" novalidate>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password2" class="form-control postion-relative" id="password2"
                                name="password2" required>
                            <div class="form-text"></div>
                        </div>
                        <div class="mb-3">
                            <label for="employeeID" class="form-label">員工認證碼</label>
                            <span style="color: lightcoral;font-size: 10px;;">&nbsp;&nbsp;*必填</span>
                            <input type="employeeID" class="form-control postion-relative" id="employeeID"
                                name="employeeID" required>
                            <div id="formAlert" class="alert alert-info" style="display: none"></div>
                        </div>
                        <div class="text-end mt-4"><a href="index.php" class="btn btn-canc me-4 " role="button">
                                取消</a><button type="submit" class="btn btn-rgst me-4">註冊</button></div>
                    </form>
                </div>
            </div>
        </div>
